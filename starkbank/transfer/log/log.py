...
from ..transfer import _resource as _transfer_resource
...
def query(limit=None, transfer_ids=None, types=None, after=None, before=None, user=None):
    ...
    """
    return rest.get_list(resource=_resource, limit=limit, user=user, types=types, transfer_ids=transfer_ids, after=check_date(after), before=check_date(before))
