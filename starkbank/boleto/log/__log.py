...
def query(limit=None, boleto_ids=None, types=None, after=None, before=None, user=None):
    ...
    """
    return rest.get_list(resource=_resource, limit=limit, user=user, types=types, boleto_ids=boleto_ids, after=check_date(after), before=check_date(before))
