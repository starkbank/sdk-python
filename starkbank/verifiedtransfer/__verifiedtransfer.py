...
class VerifiedTransfer(Resource):
    ...
    - rules [list of transfer.Rule objects, default []]: list of transfer.Rule objects for modifying transfer behaviour. ex: [transfer.Rule(key="resendingLimit", value=5)]
