...
class InvoicePullRequest(Resource):
    ...
    ## Parameters (required):
    - subscription_id [string]: Unique of the InvoiceSubscription related to the invoice. ex: "5656565656565656"
    ...
    def __init__(self, subscription_id, invoice_id, due, attempt_type=None, tags=None, external_id=None,
                 display_description=None, id=None, status=None, bacen_id=None, installment_id=None,
...
def query(limit=None, status=None, invoice_ids=None, subscription_ids=None, external_ids=None, 
    ...
    - subscription_ids [list of strings, default None]: list of InvoiceSubscription ids to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]
