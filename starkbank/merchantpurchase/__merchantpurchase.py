...
class MerchantPurchase(Resource):
    ...
    ## Parameters (optional):
    - card_expiration [string, default None]: card and holder data, required only when not created through a MerchantSession.
    - card_number [string, default None]: card and holder data, required only when not created through a MerchantSession.
    - card_security_code [string, default None]: card and holder data, required only when not created through a MerchantSession.
    - holder_name [string, default None]: card and holder data, required only when not created through a MerchantSession.
    - holder_email [string, default None]: card and holder data, required only when not created through a MerchantSession.
    - holder_phone [string, default None]: card and holder data, required only when not created through a MerchantSession.
    - holder_id [string, default None]: card and holder data, required only when not created through a MerchantSession.
    - billing_country_code [string, default None]: billing address data.
    - billing_city [string, default None]: billing address data.
    - billing_state_code [string, default None]: billing address data.
    - billing_street_line_1 [string, default None]: billing address data.
    - billing_street_line_2 [string, default None]: billing address data.
    - billing_zip_code [string, default None]: billing address data.
