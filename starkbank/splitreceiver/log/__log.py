...
from ..__splitreceiver import _resource as _receiver_resource
...
class Log(Resource):
    ...
    def __init__(self, id, created, type, errors, receiver):
        Resource.__init__(self, id=id)

        self.created = check_datetime(created)
        self.type = type
        self.errors = errors
        self.receiver = from_api_json(_receiver_resource, receiver)


_resource = {"class": Log, "name": "SplitReceiverLog"}
...
def query(limit=None, after=None, before=None, types=None, receiver_ids=None, user=None):
    ...
    - receiver_ids [list of strings, default None]: list of splitreceiver ids to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]
    - user [Organization/Project object, default None]: Organization or Project object. Not necessary if starkbank.user was set before function call
    ## Return:
...
def page(cursor=None, limit=None, after=None, before=None, types=None, receiver_ids=None, user=None):
